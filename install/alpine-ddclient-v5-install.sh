...
$STD apk add ddclient
cat <<EOF >/etc/periodic/hourly/ddclient.sh
#!/bin/sh
/usr/bin/ddclient -force
EOF
$STD mv /etc/ddclient/ddclient.conf.sample /etc/ddclient/ddclient.conf
$STD chmod +x /etc/periodic/hourly/ddclient.sh
$STD rc-service ddclient start

...
CL=`echo "\033[m"`
while true; do
    read -p "This will create a New Unprivileged Debian Bulleyes LXC. Proceed(y/n)?" yn
    case $yn in
        [Yy]* ) break;;
        [Nn]* ) exit;;
...
lxc-cmd bash -c "$(wget -qLO - https://raw.githubusercontent.com/tteck/Proxmox/main/unpriv/debian-install.sh)" || exit

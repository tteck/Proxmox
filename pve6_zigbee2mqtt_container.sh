...
wget -qL https://raw.githubusercontent.com/tteck/Proxmox/main/pve6_zigbee2mqtt_setup.sh
...
pct start $CTID
pct push $CTID pve6_zigbee2mqtt_setup.sh /pve6_zigbee2mqtt_setup.sh -perms 755
pct exec $CTID /pve6_zigbee2mqtt_setup.sh

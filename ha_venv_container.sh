...
wget -qL https://raw.githubusercontent.com/tteck/Proxmox/main/ha_venv_setup.sh
...
pct start $CTID
pct push $CTID ha_venv_setup.sh /ha_venv_setup.sh -perms 755
pct exec $CTID /ha_venv_setup.sh

# Get network details and show completion message
IP=$(pct exec $CTID ip a s dev eth0 | sed -n '/inet / s/\// /p' | awk '{print $2}')
info "Successfully created Home Assistant venv LXC Container to $CTID at IP Address ${IP}"

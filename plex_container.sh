...
while true; do
    read -p "This will create a New Plex Server LXC. Proceed(y/n)?" yn
    case $yn in
        [Yy]* ) break;;
        [Nn]* ) exit;;
...
wget -qL https://raw.githubusercontent.com/tteck/Proxmox/main/plex_setup.sh
...
info "Successfully created a Plex Server LXC to $CTID at IP Address ${IP}"

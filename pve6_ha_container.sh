...
wget -qL https://raw.githubusercontent.com/tteck/Proxmox/main/pve6_ha_setup.sh
...
pct start $CTID
pct push $CTID pve6_ha_setup.sh /pve6_ha_setup.sh -perms 755
pct exec $CTID /pve6_ha_setup.sh
